...
### 5. [7z](https://www.7-zip.org/a/7z2500-extra.7z)

无需安装的解压压缩工具

### 6. [lockhunter](https://lockhunter.com/assets/exe/lockhuntersetup_3-4-3.exe)
...
[xpano](https://github.com/krupkat/xpano) 一个自动拼接多张照片的工具

[rang](https://github.com/agauniyal/rang)，控制台彩色输出库 headonly

[qbin](https://github.com/quick-bin/qbin) 在线编辑文档

[QtScrcpy](https://github.com/barry-ran/QtScrcpy/blob/dev/README_zh.md) Android投屏工具

[scrcpy](https://github.com/Genymobile/scrcpy) Android投屏工具 (Q95用了)

[weathr](https://github.com/Veirt/weathr) 终端程序，显示天气，用来做为壁纸似乎也不错

openwrt的一个主题，[luci-theme-aurora](https://github.com/eamonxg/luci-theme-aurora/blob/master/README_zh.md)

<div align="right"><font color="#999"><small>📅 Created: 2024-03-06  ·  ✏️ Update: 2026-03-06</small></font></div>
