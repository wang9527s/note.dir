...
> wsl 环境参见 `11.wsl.md`；vmware 共享文件夹（含 samba 失败记录）参见 `04.vmware虚拟机和window文件共享.md`
...
<div align="right"><font color="#999"><small>📅 Created: 2025-05-23  ·  ✏️ Update: 2025-05-23</small></font></div>
