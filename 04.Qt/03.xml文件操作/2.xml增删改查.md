...
int main(int argc, char *argv[])
{
    ...
    QString str=QCoreApplication::applicationDirPath()+"/test.xml";
    QWidget w;
    WriteXml(str);
    ReadXml(str);
    AddXml(str);
